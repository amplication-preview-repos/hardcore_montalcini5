...
import { BugListRelationFilter } from "../../bug/base/BugListRelationFilter";
import { FileListRelationFilter } from "../../file/base/FileListRelationFilter";
import { WikiListRelationFilter } from "../../wiki/base/WikiListRelationFilter";
...
class RepositoryWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => BugListRelationFilter,
  })
  @ValidateNested()
  @Type(() => BugListRelationFilter)
  @IsOptional()
  @Field(() => BugListRelationFilter, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => WikiListRelationFilter,
  })
  @ValidateNested()
  @Type(() => WikiListRelationFilter)
  @IsOptional()
  @Field(() => WikiListRelationFilter, {
    nullable: true,
  })
